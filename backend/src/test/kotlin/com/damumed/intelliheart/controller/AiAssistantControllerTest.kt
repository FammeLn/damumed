...
class AiAssistantControllerTest {
    ...
    fun testProcessQuerySuccess() {
        ...
        val expectedResponse = com.damumed.intelliheart.dto.AssistantResponse(
            text = "Мен сізді дәрігерге жазуға көмектесемін",
            action = AssistantAction.NAVIGATE_TO_APPOINTMENT.name
        )
        ...
        assert(response.body?.action == AssistantAction.NAVIGATE_TO_APPOINTMENT.name)
    ...
    fun testServiceInvocation() {
        ...
        val expectedResponse = com.damumed.intelliheart.dto.AssistantResponse(
            ...
            action = AssistantAction.NAVIGATE_TO_RECORDS.name
        )
